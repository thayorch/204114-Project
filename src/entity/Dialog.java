...
public class Dialog {
    ...
    private int gaugeSpeed = 3; // Speed of the gauge movement
    ...
    public int getGauge(){
        gameState.bulletPower = bulletPower;
        return gauge;
    }
    ...
    public void showDialog(Graphics2D g2, int random_x) {
        ...
        else if(gauge >= x_position + random_x + zone_3_width && gauge <= x_position + random_x + zone_3_width + zone_2_width) // right
          gameState.bulletPower = 2;

        // zone 1
        else if(gauge >= x_position + random_x - zone_2_width - zone_1_width && gauge <= x_position + random_x + zone_2_width + zone_1_width) // left
